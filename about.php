...
<div class="inner-page">
  ...
  <section class="about-hero">
    ...
    <div class="about-hero-actions v2-final-cta-btns">
      <a href="index.php#plans" class="v2-btn-primary"><i class="fa-solid fa-layer-group"></i> Explore Our Plans</a>
  ...
  <section class="section products-section" aria-labelledby="products-heading">
    <div class="section-inner">
      ...
      <div class="products-grid">
        <a href="websites.php#static" class="product-card">
        ...
        <a href="websites.php#dynamic" class="product-card">
          <div class="product-card-header">
  ...
  <section class="v2-final-cta">
    <h2>Ready to Take Your School <span class="grad">Digital?</span></h2>
    ...
    <div class="v2-final-cta-btns">
      ...
      <a href="contact.php" class="v2-btn-outline"><i class="fa-solid fa-envelope"></i> Contact Us</a>
    </div>
  </section>
