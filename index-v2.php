<?php
/**
 * index-v2.php - Archived pre-v2 homepage
 *
 * The live homepage is /index.php (v2 design).
 * This file preserves the previous design for reference. It renders
 * normally so you can preview the old look, but it is NOT indexed
 * (robots:noindex,nofollow + canonical points to /index.php).
 */
$site_name = "Schoozie";
$year = date("Y");
...
<title>[Archived] Schoozie - Pre-v2 Homepage Reference</title>
<meta name="description" content="Internal archive of the pre-v2 Schoozie homepage. The live homepage is at /index.php.">
<meta name="robots" content="noindex, nofollow"><!-- archived: do not index -->
...
<section class="pricing" id="pricing">
  ...
  <div class="cards">
    ...
    <div class="card card-white">
      ...
      <button class="c-btn btn-red" onclick="window.location='websites.php#static'">Get This Plan</button>
      <a href="websites.php#static" class="c-link">Full details &amp; terms &rarr;</a>
    </div>
    ...
    <div class="card card-pink">
      ...
      <button class="c-btn btn-pink" onclick="window.location='websites.php#dynamic'">Get This Plan</button>
      <a href="websites.php#dynamic" class="c-link">Full details &amp; terms &rarr;</a>
    </div>
    ...
    <div class="card card-cyan">
      ...
      <div class="c-price">
        <div class="amount"><span class="rs">Rs.</span> <?php echo $erp_basic_quarterly; ?></div>
        <div class="per">/quarter &middot; Basic plan</div>
        <div class="per" style="margin-top:6px;color:#ccc;font-size:12px">4 plans &middot; Quarterly / Half-Yearly (5% off) / Yearly (15% off)</div>
        <span class="c-save">Mid-cycle switches prorated by day</span>
      </div>
      <div class="c-divider"></div>
      <ul class="c-feats">
    ...
    <div class="card card-gold">
      ...
      <div class="c-price">
        ...
        <div class="per" style="color:#ccc;margin-top:8px;font-size:12px">+ Any ERP tier</div>
